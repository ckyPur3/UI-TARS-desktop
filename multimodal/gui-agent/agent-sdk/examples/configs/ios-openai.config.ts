...
export default defineConfig({
  ...
  snapshot: {
    enable: true,
    storageDirectory: path.join(__dirname, '../snapshots/ios-openai'),
  },
  webui: {
    logo: 'https://lf3-static.bytednsdoc.com/obj/eden-cn/zyha-aulnh/ljhwZthlaukjlkulzlp/icon.png',
    title: 'GUI Agent - iOS (OpenAI)',
    subtitle: 'iOS mobile GUI agent powered by OpenAI GPT models',
    welcomTitle: 'iOS GUI Agent with OpenAI',
    welcomePrompts: [
